        ...
        <div class="w-size6 p-t-30 p-l-15 p-r-15 respon3">
            ...
            <div>
                <p class="s-text7 w-size27">
                    Đặt câu hỏi? Cửa hàng tại HCM hãy gọi cho chúng tôi <a href="tel:0764656477">01084208423</a>
                </p>
        ...
        <div class="w-size7 p-t-30 p-l-15 p-r-15 respon4">
            ...
            <ul>
                ...
                <li <?php
                    ...
                    ?>>
                    <a href="?mod=product&act=Categories&id=<?= $row['id_loai'] ?>"
                        class="s-text7 active1"><?= $row['loaisanpham'] ?></a>
                </li>
                <?php
                    $i++;
                    }
