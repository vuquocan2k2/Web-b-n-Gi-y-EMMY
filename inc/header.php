        ...
        <div class="container-menu-header">
            <div class="wrap_header">
                ...
                <div class="header-icons">
                    ...
                    <a href="?mod=users&act=logout" class="ask"><i class="fa fa-sign-out" aria-hidden="true"
                            title="logout" style="font-size: 20px; padding-left: 8px;cursor: pointer;"></i></a>
         ...
         ?>
                            ...
                            ?>
                                <li class="header-cart-item">
                                    <div class="header-cart-item-img">
                                        ...
                                        <a href="<?php echo $item['url_delete_cart']?>"
                                            class="header-icons-noti ask">x</a>
                                    </div>
                                    <script type="text/javascript">
                                    $(document).ready(function() {
                                        $(".ask").click(function(event) {
                                            var loc = $(this).attr('href');
                                            alertify.confirm('Are you sure to delete this product?',
                                                function(e) {
                                                    if (e) {
                                                        document.location.href = loc;
                                                    }
                                    ...
                                    <div class="header-cart-item-txt">
                                        <a href="?mod=product&act=product_detail&id=<?php echo $item['id']?>"
                    ...
                    }else  if(isset($_SESSION['is_login'])&&empty($_SESSION['cart']['buy']))
                    {
                       ?>
                                    <div class="header-cart-wrapbtn">
                                        <!-- Button -->
                                        <a href="?mod=cart&act=checkout" style="display: none"
                                            class="flex-c-m size1 bg1 bo-rad-20 hov1 s-text1 trans-0-4">
                                            Check Out
                                        </a>
                                        <?php
            ...
            if(isset($_SESSION['is_login'])){
                ...
                ?>
                        ...
                        <a href="?mod=users&act=logout"><i class="fa fa-sign-out" aria-hidden="true" title="logout"
                                onclick="return logout()"
                                style="font-size: 20px; padding-left: 8px;cursor: pointer;"></i></a>
                        <script>
                        function logout() {
