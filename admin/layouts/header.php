        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <ul class="nav navbar-right top-nav">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="divider"></li>
                        <li>
                            <sqan onclick="logout()" style="cursor: pointer;    padding-left: 21px;"><i
                                    class="fa fa-fw fa-power-off"></i> Log Out</sqan>
                        </li>
                        <script>
                        function logout() {
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    <li>
                        <a href="<?php echo base_url() ?>admin"><i class="fa fa-fw fa-dashboard"></i> Bảng điều
                            khiển</a>
                    </li>
                    ...
                    <li class="<?php echo isset($open) && $open == 'hinhanhsanpham' ? 'active' : '' ?>">
                        <a href="<?php echo modules("hinhanhsanpham")?>"> <i class="fa fa-picture-o"> </i> Hình ảnh Sản
                            phẩm</a>
                    </li>
<!-- 
                    <li class="<?php echo isset($open) && $open == 'danhmucbaiviet' ? 'active' : '' ?>">
                        <a href="<?php echo modules("danhmucbaiviet")?>"> <i class="fa fa-book"> </i> Danh mục Bài
                            viết</a>
                    </li>
                    ...
                    <li class="<?php echo isset($open) && $open == 'donhang' ? 'active' : '' ?>">
                        <a href="<?php echo modules("donhang")?>"> <i class="fa fa-shopping-cart"> </i> Quản lý Hóa
                            Đơn</a>
                    </li>


                    <li class="<?php echo isset($open) && $open == 'danhsachhoadon' ? 'active' : '' ?>">
                        <a href="<?php echo modules("danhsachhoadon")?>"> <i class="fa fa-calendar-o"> </i> Danh sách
                            đơn hàng</a>
                    </li>
