        ...
        <form class="form-horizontal" action="" method="POST" enctype="multipart/form-data">
            <div class="form-group col-sm-8">
                ...
                <select class="form-control col-md-8" name="maloai" id="">
                    ...
                    <option value="<?php echo $item['id_loai'] ?>"
                        <?php echo $editproduct['id'] == $item['id_loai'] ? "selected = 'selected' "  : ''  ?>>
                        <?php echo $item['loaisanpham'] ?> </option>
                    <?php endforeach ?>
                </select>
            ...
            <div class="form-group col-sm-8">
                ...
                <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Tên sản phẩm" name="tensp"
                    value="<?php echo $editproduct['tensp'] ?>">
            ...
            <div class="form-group col-sm-8">
                ...
                <input type="number" class="form-control" id="exampleInputEmail1" placeholder="9.000.000" name="gia"
                    value="<?php echo $editproduct['gia'] ?>">
            ...
            <div class="form-group col-sm-8">
                ...
                <input type="number" class="form-control" id="exampleInputEmail1" placeholder="0" name="soluong"
                    value="<?php echo $editproduct['soluong'] ?>">
            ...
            <div class="form-group col-sm-8">
                ...
                <textarea class="form-control" name="motangan" id=""
                    rows="4"><?php echo $editproduct['motangan'] ?></textarea>
            ...
            <div class="form-group col-sm-8">
                ...
                <textarea class="form-control" name="motadai" id=""
                    rows="4"><?php echo $editproduct['motadai'] ?></textarea>
