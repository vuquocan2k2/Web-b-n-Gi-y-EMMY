                ...
                <div class="flex-r-m flex-w p-t-10">
                    <div class="w-size16 flex-m flex-w">
                        <div class="flex-w bo5 of-hidden m-r-22 m-t-10 m-b-10">
                            <button min="1" max="10" onclick="updateItem1(<?php echo $Listproductdetail['id']?>)"
                                class="btn-num-product-down color1 flex-c-m size7 bg8 eff2" type="submit"
                                value="btn_update_cart">
                                <i class="fs-12 fa fa-minus" aria-hidden="true"></i>
                            </button>
                            <input class="size8 m-text18 t-center num-product" min="1" max="10" type="number"
                                id="sl_<?php echo $Listproductdetail['id']; ?>" name="soluong" value="1">
                            <button min="1" max="10" class="btn-num-product-up color1 flex-c-m size7 bg8 eff2"
                                type="submit" value="btn_update_cart"
                                onclick="updateItem(<?php echo $Listproductdetail['id'] ?>)">
                        ...
                        <div class="btn-addcart-product-detail size9 trans-0-4 m-t-10 m-b-10">
                            ...
                            <?php
                                ...
                                ?>
                            <a href="?mod=cart&act=show" onclick="updateItem2(<?php echo $Listproductdetail['id'] ?>)"
                                title="Add to cart" id="cart"
                                class="flex-c-m size1 bg4 bo-rad-23 hov1 s-text1 trans-0-4">Add to cart</a>
                            <?php
                                }else
                                {
                                ?>
                            <a href="#" onclick="updateItem3(<?php echo $Listproductdetail['id'] ?>)"
                                title="Add to cart" id="cart"
                                class="flex-c-m size1 bg4 bo-rad-23 hov1 s-text1 trans-0-4">Add to cart</a>
                            <?php } ?>
                        </div>
                ...
                <div class="item-slick2 p-l-15 p-r-15">
                    ...
                    <div class="block2">
                        ...
                        <div class="block2-img wrap-pic-w of-hidden pos-relative <?php echo $labelnew; ?>">
                            ...
                            <div class="block2-overlay trans-0-4">
                                ...
                                <div class="block2-btn-addcart w-size1 trans-0-4">
                                    <!-- Button -->
                                    <a href="" title="Thêm giỏ hàng" onclick="cart(<?php echo $list['id']; ?>)"
                                        class="flex-c-m size1 bg4 bo-rad-23 hov1 s-text1 trans-0-4">Add to Cart</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="block2-txt p-t-20">
                            <a href="?mod=product&act=product_detail&id=<?php echo $list['id'] ?>"
