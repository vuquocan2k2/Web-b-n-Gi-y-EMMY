            ...
            <div class="col-md-6 p-b-30">
                <div class="order-summary">
                    ...
                    <?php
                       ...
                       $currentDate = getdate();
                        ...
                        $dgia = $sp["gia"];
                        $ten = $sp["tensp"];
                        $sql = "INSERT INTO cthoadon(ma_HD, ma_SP, soluong, dongia) VALUES($ma_HD, $ma_SP ,$sluong, $dgia)";
                        $conn->query($sql);
                    ...
                    <?php
                          ...
                          ?>
                    echo "<script>
                    alert(' Order payment is unsuccessful.');
                    location.href = '?mod=cart&act=checkout'
                    </script>";
                    ...
                    <table class="table table-bordered" style="text-align: center">
                        <tbody>
                            ...
                            <tr class="order-total">
                                <th>Tổng</th>
                                <td class="text-center"><strong><span class="primary-color"> $
                                            <?php echo get_total_cart(); ?></span></strong></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                <div class="w-size25">
                    ...
                    <input type="submit" class="flex-c-m size2 bg1 bo-rad-23 hov1 m-text3 trans-0-4"
                        style="cursor: pointer" value="PLACE ORDER">
                </div>
            </div>
            <div class="col-md-6 p-b-30">
                ...
                <div class="bo4 of-hidden size15 m-b-20">
                    <input class="sizefull s-text7 p-l-22 p-r-22" type="text" name="fullname"
                        placeholder="<?php echo $list_user['name']?>" value="<?php echo $list_user['name']?>"
                        class="form-control">
                </div>
                <div class="bo4 of-hidden size15 m-b-20">
                    <input class="sizefull s-text7 p-l-22 p-r-22" type="text" name="company" placeholder="Company"
                        class="form-control" required>
                </div>
                <div class="bo4 of-hidden size15 m-b-20">
                    <input class="sizefull s-text7 p-l-22 p-r-22" type="text" name="emailaddress"
                        placeholder="<?php echo $list_user['email']?>" class="form-control"
                        value="<?php echo $list_user['email']?>" required>
                </div>
                <div class="bo4 of-hidden size15 m-b-20">
                ...
                <div class="bo4 of-hidden size15 m-b-20">
                    <input class="sizefull s-text7 p-l-22 p-r-22" type="text" name="province" placeholder="Province"
                        class="form-control" required>
                </div>
                <div class="bo4 of-hidden size15 m-b-20">
                ...
                <div class="bo4 of-hidden size15 m-b-20">
                    <input class="sizefull s-text7 p-l-22 p-r-22" type="text" pattern="[0-9]{10}" name="telephone"
                ...
                ?>
                <p> Cart has no product. Please <a href="?mod=product&act=main" style="color: red">return</a> to the
                    shopping page.</p>
                <?php
                }
                ?>
