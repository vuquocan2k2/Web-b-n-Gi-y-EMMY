...
{
	$id_loai=$_GET['id'];
	$number_rows = db_num_rows("SELECT * FROM sanpham where maloai= $id_loai and trangthai = 1 ORDER BY gia DESC");
	// echo $number_rows;	
}
else
{
...
{
	$id_loai=$_GET['id'];
	$Listproduct = get_product_highlow_cate($start, $num_per_page,$id_loai);
}
else
{
	$Listproduct = get_product_highlow($start, $num_per_page);
}
        ...
        <div class="row">
            ...
            <div class="col-sm-6 col-md-8 col-lg-9 p-b-50">
                ...
                <div class="pagination flex-m flex-w p-t-26" style="margin: auto;     margin-left: 50%;">
					...
					echo get_pagging($num_page, $page, "?mod=sort&act=high_low",$id_loai);
					?>
                </div>
            </div>
